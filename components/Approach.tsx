  ...
  return (
    <section className='w-full py-20'>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Development and Progress Update" icon={<AceternityIcon order="Phase 2" />}
...
const AceternityIcon = ({order}: {order:string}) => {
  ...
  <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] z-index:0" />
  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-white backdrop-blur-3xl text-2xl font-bold z-index:10">
    {order}
  </span>
</button>
    </div>
